...
document.addEventListener('keydown',function(event){
  ...
  if (event.key =='Enter') {
    ...
    alert(alertstring)
    if(confirm("really?\n 真的吗")){
      window.open('https://qiyongchuan.github.io/hexopp/archives/', 'newWindow', 'height=300,width=400');
      window.open('https://github.com/QiYongchuan/MyGitBlog', 'newWindow', 'height=300,width=400');
    } else {
      alert("That is ok")
    }
